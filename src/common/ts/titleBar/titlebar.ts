...
const INACTIVE_FOREGROUND_DARK = Color.fromHex('#33333399');
const ACTIVE_FOREGROUND_DARK = Color.fromHex('#333333');
const INACTIVE_FOREGROUND = Color.fromHex('#CCCCCC99');
const ACTIVE_FOREGROUND = Color.fromHex('#CCCCCC');
...
export class Titlebar extends Themebar {
	...
	private updateStyles() {
	  if (this.titlebar) {
	    ...
	    const titleBackground = this.isInactive ? this._options.backgroundColor.transparent(.6) : this._options.backgroundColor;
   ...
   */
	...
	updateMenuPosition(menuPosition: "left" | "bottom") {
	  ...
	  this.titlebar.style.webkitFlexWrap = this._options.menuPosition && this._options.menuPosition === 'bottom' ? 'wrap' : 'nowrap';
