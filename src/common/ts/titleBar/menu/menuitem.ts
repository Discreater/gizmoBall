...
export class MenuItem extends Disposable implements IMenuItem {
	...
	onClick(event: EventLike) {
	  ...
	  if (this.item.click) {
	    this.item.click(this.item as unknown as Electron.MenuItem, this.currentWindow, this.event);
	  }
	...
	protected applyStyle() {
	  ...
	  this.checkElement.style.backgroundColor = fgColor ? fgColor.toString() : '';
